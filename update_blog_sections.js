...
const blogPosts = [
  { title: "Storm Damage Roof Repair Timeline: How Fast Can It Really Be Fixed?", filename: "storm-damage-roof-repair-timeline-houston.html", description: "Discover the realistic storm damage roof repair timeline in Houston. Learn how fast leaks can be stopped, repair vs replacement timeframes, and insurance claim steps.", category: "Storm Repair", date: "September 14, 2026", readTime: "11 Min Read" },
  { title: "Same-Day Roof Repair Houston: What's Actually Possible", filename: "same-day-roof-repair-houston.html", description: "Discover what emergency roof repairs can be completed same-day in Houston. Learn when pipe jacks, shingles, or tarping can stop leaks immediately.", category: "Emergency Roofing", date: "September 6, 2026", readTime: "10 Min Read" },
  { title: "Roof Truss Damage: When a Repair Isn't Enough", filename: "roof-truss-damage-when-repair-isnt-enough-houston.html", description: "Learn when damaged roof trusses in Houston can be repaired or require engineered replacement. Signs of cracked webs, sag, storm impacts, and costs.", category: "Roof Inspection", date: "August 31, 2026", readTime: "10 Min Read" },
  ...
  { title: "Insurance Roof Replacement Guide", filename: "roof-replacement-zero-cost-insurance-houston.html", description: "How Houston homeowners replace their roof through insurance claims.", category: "Insurance Claims", date: "May 12, 2026", readTime: "7 Min Read" },
...
const unsplashIdMap = {
  "storm-damage-roof-repair-timeline-houston.html": "photo-1513694203232-719a280e022f",
  "same-day-roof-repair-houston.html": "photo-1513694203232-719a280e022f",
  "roof-truss-damage-when-repair-isnt-enough-houston.html": "photo-1513694203232-719a280e022f",
...
if (navStartIndex !== -1 && navEndIndex !== -1) {
  ...
  <header id="site-header">
    <div class="header-container">
      ...
      <!-- Desktop Nav -->
      <nav class="desktop-nav" id="desktop-navbar" aria-label="Main Navigation">
        <a href="/" class="nav-link">Home</a>

        <!-- 1. Services (dropdown) -->
        <div class="dropdown">
          <span class="nav-link dropdown-toggle" tabindex="0" role="button" aria-haspopup="true" aria-expanded="false">Services</span>
          <div class="dropdown-menu dropdown-menu-wide">
            <div>
              <a class="dropdown-item" href="/roof-replacement-houston">Shingle Roof Replacement</a>
              <a class="dropdown-item" href="/metal-roofing-houston">Standing Seam Metal</a>
              <a class="dropdown-item" href="/roof-repair-houston">Roof Leak Repair</a>
              <a class="dropdown-item" href="/emergency-roof-tarping-houston">Emergency Tarping</a>
              <a class="dropdown-item" href="/storm-damage-roofing-houston">Storm Damage Restoration</a>
            </div>
            <div>
              <a class="dropdown-item" href="/hail-damage-roof-repair-houston">Hail Damage Assessment</a>
              <a class="dropdown-item" href="/wind-damage-roof-repair-houston">Wind Uplift Repair</a>
              <a class="dropdown-item" href="/gutter-installation-houston">Gutters</a>
              <a class="dropdown-item" href="/chimney-flashing-repair-houston">Chimney &amp; Flashing</a>
            </div>
          </div>
        </div>

        <!-- 2. Storm Damage -->
        <a href="/#storm-damage" class="nav-link">Storm Damage</a>
  ...
  <div class="mobile-menu" id="mobile-menu">
    ...
    <a href="/roof-replacement-houston" class="mobile-nav-link">Shingle Replacement</a>
    <a href="/storm-damage-roofing-houston" class="mobile-nav-link">Storm Damage</a>
    <a href="/blog" class="mobile-nav-link">Blog</a>
    <a href="/calculator" class="mobile-nav-link">Cost Calculator</a>
    <a href="/roofing-calculators" class="mobile-nav-link">Roofing Calculators</a>
